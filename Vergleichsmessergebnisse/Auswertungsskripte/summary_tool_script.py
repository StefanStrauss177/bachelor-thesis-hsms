...
ROOT_FOLDER = Path(".")
METHOD = <Name der auszuwertenden Methode>
...
def write_throughput_summary():
    ...
    for payload, files in sorted(grouped.items()):
        rows.append({
            ...
            "avg_min_ms": average(files, "min_ms"),
            "avg_max_ms": average(files, "max_ms"),
            "stdev_of_messages_per_sec": metric_stdev(files, "messages_per_sec"),
            "ci95_messages_per_sec": confidence_interval_95(files, "messages_per_sec"),
        })
